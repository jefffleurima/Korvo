-- Optional intake: proof of insurance (e.g. other driver's carrier/policy for auto). Text only in MVP; no document upload.
...
comment on column public.leads.insurance_info is 'Insurance details if offered (e.g. other driver carrier/policy for auto). Collect at intake or note "to collect at consultation".';
comment on column public.leads.budget_score is 'Intent scoring 1-5: estimated case value / budget fit';
